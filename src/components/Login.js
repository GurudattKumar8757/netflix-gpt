...
const Login = () => {
  ...
  return (
    <div>
      ...
      <form className="bg-opacity-80 w-3/12 p-12 bg-black absolute my-36 mx-auto right-0 left-0 text-white rounded-md">
        ...
        <input
          ...
          className="p-4 my-4 w-full bg-gray-700"
        />
        <button className="p-6 my-4 bg-red-700 w-full rounded-md">
          {isSignInForm ? "Sign In" : "Sign Up"}
        </button>
